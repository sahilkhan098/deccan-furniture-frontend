          ...
          <div className='pt-2 pb-4 space-y-1'>
            {navItems.map((item) => (
              <Link
                ...
                className='block w-full text-left text-primary-foreground/80 hover:text-red-700 hover:bg-accent/10 px-4 py-3 rounded-lg transition-all duration-300 text-base font-medium uppercase tracking-wider'
              >
                {item.name}
              </Link>
            ))}
